...
create_data_directory() {
    ...
    chown "$SERVICE_USER:$SERVICE_USER" "$DATA_DIR/logs"
...
$SERVICE_USER ALL=(ALL) NOPASSWD: /usr/bin/mkdir -m * $DATA_DIR/*
$SERVICE_USER ALL=(ALL) NOPASSWD: /bin/mkdir -p $DATA_DIR/*
$SERVICE_USER ALL=(ALL) NOPASSWD: /bin/mkdir -m * $DATA_DIR/*
$SERVICE_USER ALL=(ALL) NOPASSWD: /usr/bin/mv /tmp/* $DATA_DIR/shares/*
$SERVICE_USER ALL=(ALL) NOPASSWD: /bin/mv /tmp/* $DATA_DIR/shares/*
