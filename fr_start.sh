...
if [ -f "config/config.yaml" ]; then
    ...
    # Cibler uniquement le champ name dans la section node (2 espaces au début)
...
if [ "$USE_INTEGRATED_SHARES" = "oui" ]; then
    ...
    # Mettre à jour .env avec les identifiants (REQUIS pour le conteneur shares)
    if [ -f .env ]; then
        ...
        echo -e "${GREEN}✅ Identifiants configurés dans .env${NC}"
    fi

    # Mettre à jour config.yaml aussi (pour cohérence)
    if [ -f config/config.yaml ]; then
...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}  Étape 3c/5 : Mode de sauvegarde${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
