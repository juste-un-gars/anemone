...
func Migrate(db *sql.DB) error {
	migrations := []string{
		...
		`INSERT OR IGNORE INTO system_info (key, value) VALUES ('current_version', '0.9.6-beta')`,
		`INSERT OR IGNORE INTO system_info (key, value) VALUES ('latest_version', '0.9.6-beta')`,
